...
@Entity
@Table(name = "Pattern", indexes = { @Index(columnList = "idPattern", name = "idPattern_index") })
...
public class Pattern extends BaseObject {
	...
	/*
	 * @ManyToMany(fetch = FetchType.LAZY, mappedBy= "patterns") private List<Folder> folders = new ArrayList<>();
	 */
	...
	/*
	 * public List<Folder> getFolder() { return folders; }
	 * 
	 * public void setFolder(List<Folder> folderses) { this.folders = folderses; }
	 */
