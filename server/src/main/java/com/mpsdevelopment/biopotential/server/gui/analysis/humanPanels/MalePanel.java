...
public class MalePanel extends Pane {

	private static final Logger LOGGER = LoggerUtil.getLogger(MalePanel.class);

	private MalePanelController malePanelController;

    public MalePanel(Map<Pattern, AnalysisSummary> diseases) {
