...
/**
 * Created with IntelliJ IDEA. User: hansolo Date: 04.09.12 Time: 09:05 To change this template use File | Settings | File Templates.
 * 
 * Mods: HecklerMark Date: 25.09.12 Desc: Added stylesheet capability. Guess I need to check out IDEA for this project now (sigh). :-)
 */
	...
	public DialogFX build() {
		...
		for (String key : properties.keySet()) {
			if ("buttonsLabels".equals(key)) {
				...
				CONTROL.addButtons(((ObjectProperty<List<String>>) properties.get(key)).get(), ((IntegerProperty) properties.get("buttonsDefaultButton")).get(),
